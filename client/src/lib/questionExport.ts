...
export type QuestionPrintOptions = { includePoints?: boolean; watermark?: boolean };
...
export function openQuestionPrintView(questions: ExportQuestion[], kind: QuestionDocumentKind, workbook?: WorkbookPrintOptions, options?: QuestionPrintOptions) {
