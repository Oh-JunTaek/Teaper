...
function Router() { return <Switch><Route path="/"><Workspace><Home /></Workspace></Route><Route path="/materials"><Workspace><Materials /></Workspace></Route><Route path="/references"><Workspace><References /></Workspace></Route><Route path="/generate"><Workspace><Generate /></Workspace></Route><Route path="/quick-quiz"><Workspace><QuickQuiz /></Workspace></Route><Route path="/notes"><Workspace><Notes /></Workspace></Route><Route path="/ai-settings"><Workspace><AiSettings /></Workspace></Route><Route path="/review"><Workspace><Review /></Workspace></Route><Route path="/approved"><Workspace><Approved /></Workspace></Route><Route path="/profile"><Workspace><Profile /></Workspace></Route><Route path="/policies"><Workspace><Policies /></Workspace></Route><Route path="/admin"><Workspace><Admin /></Workspace></Route><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch>; }
