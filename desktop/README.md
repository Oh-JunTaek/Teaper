...
PDF는 설치형 화면에서 동일한 인쇄 미리보기로 제공하고, 교사가 로컬 프린터 또는 ‘PDF로 저장’을 직접 선택하도록 한다. 내보낸 시험지·정답 해설지는 민감한 시험 자료일 수 있으므로 공유 폴더·개인 클라우드 자동 동기화 위치가 아닌 학교 보안 지침에 맞는 경로에 보관해야 한다.
