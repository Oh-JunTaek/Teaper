...
console.log(JSON.stringify({ localOnly: true, bridgeUrl: `http://127.0.0.1:${bridge.port}`, setupPlanUrl: `http://127.0.0.1:${bridge.port}/setup-plan`, sessionToken: bridge.token }));
