...
const OFFICIAL_SOURCE_SEEDS = [
  ...
  { catalogKey: "kice-student-assessment", provider: "한국교육과정평가원·교육부", title: "학생평가지원포털", sourceType: "evaluation_portal" as const, listingUrl: "https://stas.moe.go.kr/", allowedUse: "link_only" as const },
  { catalogKey: "edunet-achievement-level", provider: "에듀넷", title: "성취수준(평가기준) 자료실", sourceType: "evaluation_portal" as const, listingUrl: "https://www.edunet.net/cmnBoard/list/57", allowedUse: "link_only" as const },
];
...
export async function ensureOfficialCatalog() {
  ...
  const documents = [
    ...
    { catalogKey: "2022-high-algebra-curriculum", sourceId: sourceId("moe-2022-curriculum"), title: "2022 개정 교육과정 · 대수", subject: "대수", unit: "공통", applicableYear: "2026~2027 적용", documentType: "curriculum" as const, officialUrl: OFFICIAL_SOURCE_SEEDS[0].listingUrl, issueNumber: "교육부 고시 제2022-33호 · 별책 8", publishedAt: "2022-12-22", appliesFrom: "2026-03-01", appliesTo: null, rightsStatus: "link_only" as const, catalogStatus: "published" as const, summary: "고등학교 수학 일반 선택 과목 대수의 내용 체계와 성취기준을 확인하는 2022 개정 교육과정 공식 문서입니다.", isDefault: 0 },
    { catalogKey: "2022-high-calculus-one-curriculum", sourceId: sourceId("moe-2022-curriculum"), title: "2022 개정 교육과정 · 미적분Ⅰ", subject: "미적분Ⅰ", unit: "공통", applicableYear: "2026~2027 적용", documentType: "curriculum" as const, officialUrl: OFFICIAL_SOURCE_SEEDS[0].listingUrl, issueNumber: "교육부 고시 제2022-33호 · 별책 8", publishedAt: "2022-12-22", appliesFrom: "2026-03-01", appliesTo: null, rightsStatus: "link_only" as const, catalogStatus: "published" as const, summary: "고등학교 수학 일반 선택 과목 미적분Ⅰ의 내용 체계와 성취기준을 확인하는 2022 개정 교육과정 공식 문서입니다.", isDefault: 0 },
    { catalogKey: "2022-high-probability-statistics-curriculum", sourceId: sourceId("moe-2022-curriculum"), title: "2022 개정 교육과정 · 확률과 통계", subject: "확률과 통계", unit: "공통", applicableYear: "2026~2027 적용", documentType: "curriculum" as const, officialUrl: OFFICIAL_SOURCE_SEEDS[0].listingUrl, issueNumber: "교육부 고시 제2022-33호 · 별책 8", publishedAt: "2022-12-22", appliesFrom: "2026-03-01", appliesTo: null, rightsStatus: "link_only" as const, catalogStatus: "published" as const, summary: "고등학교 수학 일반 선택 과목 확률과 통계의 내용 체계와 성취기준을 확인하는 2022 개정 교육과정 공식 문서입니다.", isDefault: 0 },
    { catalogKey: "2022-curriculum-general", sourceId: sourceId("moe-2022-curriculum"), title: "2022 개정 교육과정 · 총론", subject: "공통", unit: "공통", applicableYear: "2025~2027 적용", documentType: "curriculum" as const, officialUrl: OFFICIAL_SOURCE_SEEDS[0].listingUrl, issueNumber: "교육부 고시 제2022-33호 · 별책 1", publishedAt: "2022-12-22", appliesFrom: "2025-03-01", appliesTo: "2027-02-28", rightsStatus: "link_only" as const, catalogStatus: "published" as const, summary: "학교급별 적용 시기와 학교 교육과정 운영의 공통 기준을 확인하는 2022 개정 교육과정 총론입니다.", isDefault: 0 },
    { catalogKey: "kice-achievement-standard-search", sourceId: sourceId("kice-student-assessment"), title: "KICE 성취기준·평가기준 검색", subject: "공통", unit: "성취기준", applicableYear: "현재 제공", documentType: "achievement_standard" as const, officialUrl: "https://stas.moe.go.kr/", issueNumber: "학생평가지원포털", publishedAt: "2026-08", appliesFrom: "2025-03-01", appliesTo: null, rightsStatus: "link_only" as const, catalogStatus: "published" as const, summary: "문항을 성취기준·평가기준에 연결할 때 사용하는 KICE 학생평가지원포털 공식 검색·자료 경로입니다.", isDefault: 0 },
    { catalogKey: "kice-assessment-tool-library", sourceId: sourceId("kice-student-assessment"), title: "KICE 학생평가 도구 자료", subject: "공통", unit: "평가도구", applicableYear: "현재 제공", documentType: "guideline" as const, officialUrl: "https://stas.moe.go.kr/cmn/search/searchList", issueNumber: "학생평가지원포털", publishedAt: "2026-08", appliesFrom: "2025-03-01", appliesTo: null, rightsStatus: "link_only" as const, catalogStatus: "published" as const, summary: "수행평가·서논술형·현장중심 학생평가와 채점기준을 설계할 때 참고하는 공식 자료 경로입니다.", isDefault: 0 },
    { catalogKey: "edunet-achievement-level-library", sourceId: sourceId("edunet-achievement-level"), title: "에듀넷 성취수준(평가기준) 자료실", subject: "공통", unit: "성취수준", applicableYear: "현재 제공", documentType: "achievement_standard" as const, officialUrl: "https://www.edunet.net/cmnBoard/list/57", issueNumber: "에듀넷 자료실", publishedAt: "2026-08", appliesFrom: "2025-03-01", appliesTo: null, rightsStatus: "link_only" as const, catalogStatus: "published" as const, summary: "2022 개정 교육과정 성취수준과 평가기준을 과목별로 확인하는 공식 자료실입니다.", isDefault: 0 },
  ];
...
export async function listOfficialDocuments(subject?: string) {
  ...
  return subject ? rows.filter(row => row.document.subject === subject || row.document.subject === "공통") : rows;
}
