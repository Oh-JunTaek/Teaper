...
object QuickQuizPromptContract {
    ...
    fun generationPrompt(subject: String, unit: String, topic: String, difficulty: String, questionFormat: String, questionCount: Int, teacherInstructions: String): String = buildString {
        ...
        appendLine(when (questionFormat) { "short_answer" -> "문항 형식은 주관식입니다. 보기는 반드시 ‘보기: 없음’으로 쓰고, 짧은 용어·수식·숫자로 답할 수 있는 문항만 작성하십시오."; "ox" -> "문항 형식은 O/X입니다. 짧은 진술 하나를 제시하고 ‘보기: O / X’로 쓰며, 정답은 O 또는 X 하나만 작성하십시오."; else -> "문항 형식은 객관식 4지선다입니다. 서로 다른 보기 4개를 정확히 쓰고, 정답은 ①·②·③·④ 중 하나로 작성하십시오." })
